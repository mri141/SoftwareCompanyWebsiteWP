...
<head>
        ...
        <title>Enrich IT Solution</title>
    ...
    <body>
          ...
          <header>
            <nav class="navbar navbar-expand-lg navbar-light navbar-float">
              <div class="container">
                <a href="welcome.blade.php" class="navbar-brand">Enrich IT<span class="text-primary">Solution</span></a>
            ...
            <div class="page-section counter-section">
              <div class="container">
                <div class="row align-items-center text-center">
                  <div class="col-lg-4">
                    <p>Total Invest</p>
                    <h2><span class="number" data-number="816278"></span> TK</h2>
                  </div>
                  <div class="col-lg-4">
                    <p>Yearly Revenue</p>
                    <h2><span class="number" data-number="216422"></span> TK</h2>
                  </div>
                  <div class="col-lg-4">
                    <p>Growth Ration</p>
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-sm-6 py-2">
                  <p id="copyright">&copy; 2022 <a href="https://rashed.a2zhelpline.com/">Rashedul Islam</a>. All rights reserved</p>
                </div>
